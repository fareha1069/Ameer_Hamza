    ...
    <div className="flex flex-col items-center">
      ...
      >
        <div className="flex flex-col items-center w-[90vw]">
          ...
          <p className="text-base md:text-xl lg:w-[80vw]">{intro}</p>
      ...
      <Motion.div
        className="flex flex-col lg:flex-row justify-around items-center my-12"
      ...
      >
        <div className="w-[90vw] lg:w-[45vw] flex flex-col text-lg">
          <h1
            className="title text-2xl md:text-4xl xl:text-5xl font-bold text-[#092936] tracking-tight leading-[1.5] bg-clip-text text-transparent inline-block bg-[length:300%_300%] mb-3"
            style={{ fontFamily: "Oswald, monospace" }}
          >
            Strategic E-Commerce Supply Chain Services
          </h1>
          <p className="text-base md:text-xl">
            Comprehensive solutions from forecasting to fulfillment, tailored
            for Amazon, Shopify, and global markets. Driving efficiency,
            reducing costs, and optimizing operations for sustained business
            growth.
          </p>
      ...
      <div className="flex flex-col items-center justify-center w-full p-6">
        <h1
          className="title text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-[#092936] tracking-tight leading-[1.5] bg-clip-text text-transparent inline-block bg-[length:300%_300%] mb-3"
          style={{ fontFamily: "Oswald, monospace" }}
        >
          Why Choose Me?
        </h1>
