  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-start justify-around flex-1 mt-1 px-5 pt-5">
        {/* Contact Section */}
        <Motion.div
          className=" flex flex-col gap-3 w-[70vw] md:w-[40vw] text-white"
        ...
        {/* Quick Links Section */}
        <Motion.div
          className="px-5 flex flex-col justify-start gap-4 w-[70vw] md:w-[40vw] text-white border-l-2 border-gray-400"
          initial={{ y: 80, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1, ease: 'easeOut' }}
        >
      ...
      <div className="border-t border-gray-500 py-2">
        <p className="text-base text-center text-white">
          Developed by{" "}
          <a href="https://www.upwork.com/freelancers/~0108560147dde16c96?viewMode=1" className="text-lg" style={{ fontFamily: "Oswald, monospace" }}>
            Fareha Ilyas
          </a>{" "}
          and{" "}
          <a href="https://www.upwork.com/freelancers/~012c4017169ba24b43?viewMode=1" className="text-lg" style={{ fontFamily: "Oswald, monospace" }}>
            Aneeba Waseem
          </a>
        </p>
      </div>
